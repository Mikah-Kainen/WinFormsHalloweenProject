...
namespace WinFormsHalloweenProject
{
    ...
    public partial class Graph
    {
        ...
        Node SetupNodes(HashSet<Form1.RECT> rectangles, Point ghostLocation)
        {
            Nodes.Clear();
        ...
        public Point[] GetPath(HashSet<Form1.RECT> rectangles, Point ghostLocation, out bool noPath)
        {
